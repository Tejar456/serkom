<template>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
      <h2 class="text-2xl font-bold md:text-4xl md:leading-tight">Program Keahlian</h2>
      <p class="mt-1 text-gray-600">Program kehlaian yang ada di SMKN 4 Tasikmalaya</p>
    </div>
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-2">
      ...
      <a data-aos="fade-up" data-aos-delay="0"
        ...
        <div class="mt-5">
          <p class="mt-1 text-gray-600">
            Pengembangan Perangkat Lunak dan Game berfokus pada pembuatan aplikasi perangkat lunak dan pengembangan
            game, termasuk pemrograman dan desain game.</p>
          <span
      ...
      <a data-aos="fade-up" data-aos-delay="200"
        ...
        <div class="mt-5">
          <p class="mt-1 text-gray-600">Teknik Jaringan Komputer dan Telekomunikasi mempersiapkan siswa untuk merancang,
            menginstal, dan memelihara jaringan komputer serta sistem telekomunikasi.</p>
          <span
            class="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium">
            Learn more
            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
      ...
      <a data-aos="fade-up" data-aos-delay="400"
        ...
        <div class="mt-5">
          <p class="mt-1 text-gray-600">Teknik Sepeda Motor mengajarkan keterampilan dalam memperbaiki, merawat, dan
            memelihara sepeda motor.</p>
          <span
            class="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium">
            Learn more
            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
      ...
      <a data-aos="fade-up" data-aos-delay="0"
        ...
        <div class="mt-5">
          <p class="mt-1 text-gray-600"> Desain Komunikasi Visual berfokus pada Fotografi dan Videografi untuk
            menciptakan dan mengolah gambar serta video sebagai media komunikasi visual.</p>
          <span
            class="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium">
            Learn more
            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
      ...
      <a data-aos="fade-up" data-aos-delay="200"
        ...
        <div class="mt-5">
          <p class="mt-1 text-gray-600">Teknik Otomasi Industri mempelajari penerapan teknologi dalam sistem otomatisasi
            di industri manufaktur.</p>
          <span
            class="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium">
            Learn more
            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
